        ...
        <div className="space-y-4">
          {services.map((service, index) => (
            <ScrollReveal key={service.number} delay={0.1 + index * 0.15} direction={index % 2 === 0 ? 'left' : 'right'}>
              <div className="group relative glass rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-[0_0_60px_hsl(0_0%_100%/0.06)]">
                {/* Background shimmer on hover */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-foreground/[0.03] to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000" />
                </div>
                
                <div className="relative p-8 md:p-12 flex flex-col md:flex-row md:items-center gap-6 md:gap-12">
                  {/* Number */}
                  <div className="flex-shrink-0">
                    <span className="text-display text-6xl md:text-8xl font-bold text-foreground/[0.06] group-hover:text-foreground/[0.12] transition-colors duration-500">
                      {service.number}
                    </span>
                  </div>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <h3 className="text-display text-3xl md:text-4xl lg:text-5xl group-hover:text-foreground transition-colors duration-500">
                        {service.title}
                      </h3>
                    </div>
                  ...
                  {/* Arrow */}
                  <div className="hidden md:flex items-center justify-center w-14 h-14 rounded-xl glass group-hover:bg-foreground/[0.08] transition-all duration-500">
